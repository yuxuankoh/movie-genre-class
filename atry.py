            ...
            if len(grad_indexes) >0:
                ...
                for j in range(len(cols)):
                    with cols[j]:
                        ...
                        MovieModel.run_gradCAM(img = image, pred_index = grad_indexes[j], alpha = 2)
        ...
        if (view_alt):
            if (user_input == 'Horror'):
                ...
                with col1:
                    ...
                    MovieModel.style_transfer(image, horror1)
            #horror = tf.image.resize(horror, (256,256))
                with col2:
                    ...
                    MovieModel.style_transfer(image, horror2)
                with col3:
                    st.write("Choice 3")
                    ...
                    MovieModel.style_transfer(image, horror3)
                ...
                with col1:
                    ...
                    MovieModel.style_transfer(image, drama1)
                with col2:
                    st.write("Choice 2")
                    ...
                    MovieModel.style_transfer(image, drama2)
                with col3:
                    st.write("Choice 3")
                    ...
                    MovieModel.style_transfer(image, drama3)
                ...
                with col1:
                    ...
                    MovieModel.style_transfer(image, action1)
                with col2:
                    st.write("Choice 2")
                    ...
                    MovieModel.style_transfer(image, action2)
                with col3:
                    st.write("Choice 3")
                    ...
                    MovieModel.style_transfer(image, action3)
                ...
                with col1:
                    ...
                    MovieModel.style_transfer(image, comedy1)
                with col2:
                    st.write("Choice 2")
                    ...
                    MovieModel.style_transfer(image, comedy2)
                with col3:
                    st.write("Choice 3")
                    ...
                    MovieModel.style_transfer(image, comedy3)
                ...
                with col1:
                    ...
                    MovieModel.style_transfer(image, thriller1)
                with col2:
                    st.write("Choice 2")
                    ...
                    MovieModel.style_transfer(image, thriller2)
                with col3:
                    st.write("Choice 3")
                    ...
                    MovieModel.style_transfer(image, thriller3)
